...
@extend_schema(
    ...
    parameters=[
        ...
        OpenApiParameter(name="min_latitude", type=OpenApiTypes.FLOAT, location=OpenApiParameter.QUERY,
                         description="Minimum latitude"),
        OpenApiParameter(name="max_latitude", type=OpenApiTypes.FLOAT, location=OpenApiParameter.QUERY,
                         description="Maximum latitude"),
        OpenApiParameter(name="min_longitude", type=OpenApiTypes.FLOAT, location=OpenApiParameter.QUERY,
                         description="Minimum longitude"),
        OpenApiParameter(name="max_longitude", type=OpenApiTypes.FLOAT, location=OpenApiParameter.QUERY,
        ...
        OpenApiParameter(name="user", type=OpenApiTypes.STR, location=OpenApiParameter.QUERY,
                         description="Username of the property owner (exact)"),
